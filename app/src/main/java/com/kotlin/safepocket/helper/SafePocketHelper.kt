...
import com.kotlin.safepocket.models.Account
import com.kotlin.safepocket.models.Category
import com.kotlin.safepocket.models.CreditCard
import com.kotlin.safepocket.models.Security

object SafePocketHelper {
    ...
    private fun setStrengthColor(view: ImageView, colorId: Int) {
        view.setBackgroundColor(colorId)  //set color for security level
    }
    ...
    fun activityAccountDetailBinding(activity: Activity, binding: ActivitySecurityDetailBinding?, security: Security?) {
        security?.let { safetySecurity ->
            binding?.let { it ->
                ...
                SafePocketHelper.setPasswordStrengthLevel(activity, safetySecurity.passwordStrengthLevel, it.included.level1, it.included.level2, it.included.level3, it.included.level4, it.included.level5)
